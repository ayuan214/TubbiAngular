...
function yelp(db_results) {
    var auth = {
            ...
            parameters.push(['radius_filter', 40000]);
                ...
                'success' : function(data, textStats, XMLHttpRequest) {
                    ...
                    for(var i=0; i<db_results.length; i++) {
                        for (var j=0; j<data.businesses.length; j++) {
                            if (db_results[i].bizID == data.businesses[j].id) {
                                console.log('Match');
                                console.log(db_results[i].bizID);
                                console.log(data.businesses[j].id);
                            } // end of if loop
                        }// end of j loop
                    } // end of i loop
